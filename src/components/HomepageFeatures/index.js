...
const FeatureList = [
  ...
  {
    title: <Translate id="homepage.features.focus.title">Focus on What Matters</Translate>,
  ...
  {
    title: <Translate id="homepage.features.powered.title">Powered by React</Translate>,
